...
//     // Logic for scheduling tasks can be implemented here
//     if (subject && taskType && priority && dueDate) {
//       toast.success('Task scheduled successfully!'); // Placeholder for actual scheduling logic
//     } else {
//       //toast.error('Please fill out all fields before scheduling.');
//     }
//   };

//   return (
//     <div className="card bg-base-100 shadow-xl opacity-90 mx-auto p-4 max-w-sm">
...
//           />
//         </div>
//         <button className='btn btn-outline w-full' type="submit">Add Task</button>
//       </form>

//       {/* Schedule Button */}
//       <div className="mt-4">
//         <button className='btn btn-outline w-full' onClick={handleSchedule}>Schedule Task</button>
//       </div>
  ...
  return (
    <div className="card bg-base-100 shadow-lg opacity-90 mx-auto p-2 max-w-xs" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
      <form onSubmit={handleSubmit} className="space-y-2">
        ...
        <button className='btn btn-outline w-full h-8 text-sm' type="submit">Add Task</button>
      </form>

      {/* Schedule Button */}
      <div className="mt-2">
        <button className='btn btn-outline w-full h-8 text-sm' onClick={handleSchedule}>Schedule Task</button>
      </div>
