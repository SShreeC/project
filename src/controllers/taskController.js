...
//     const { subject, taskType, priority, dueDate, completed } = req.body;
//     const userId = req.user.id; // Assuming `req.user` contains user info from token
...
// //new function to schedule tasks
...
//   getTasks,
//   addSubject,
//   getSubjects,scheduleTasks // Export the new getSubjects function
// };
const Task = require('../models/task');
const Subject = require('../models/subject'); // Import the Subject model
const { authenticateToken } = require('../utils/jwtUtils');
